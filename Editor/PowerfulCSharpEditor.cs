...
namespace Editor
{
    public partial class PowerfulCSharpEditor : Form
    {
        ...
        private Style sameWordsStyle = new MarkerStyle(new SolidBrush(Color.Orange/*Color.FromArgb(50, Color.Gray)*/));
                ...
                if (e.ColumnIndex == 1)
                    ...
                    switch (item.type)
                    {
                        case ExplorerItemType.Class:
                            //e.Value = global::Editor.Properties.Resources.class_libraries;
                            return;
                        case ExplorerItemType.Method:
                            //e.Value = global::Editor.Properties.Resources.box;
                            return;
                        case ExplorerItemType.Event:
                            //e.Value = global::Editor.Properties.Resources.lightning;
                            return;
                        case ExplorerItemType.Property:
                            //e.Value = global::Editor.Properties.Resources.property;
                            return;
                    }
            }
            catch{;}
